...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        # variable.                                                                #
        ############################################################################
        Z, cache1 = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        Z, cache2 = affine_relu_forward(Z, W2, b2)
        scores, cache3 = affine_forward(Z, W3, b3)
        ...
        dx, dw1, db1 = conv_relu_pool_backward(dout, caches.pop())
