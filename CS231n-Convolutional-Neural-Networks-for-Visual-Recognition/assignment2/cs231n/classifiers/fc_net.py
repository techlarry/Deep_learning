...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    dx1 , dw1, db1 = affine_relu_backward(dout, cache1)
...
class FullyConnectedNet(object):
  ...
  def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
    ...
    ############################################################################
    layer_dims = [input_dim] + hidden_dims + [num_classes] # contruct layer dims
    L = self.num_layers
  ...
  def loss(self, X, y=None):
    ...
    for i in range(1, L):
        ...
        if not self.use_batchnorm:
            ...
            Z, cache2 = batchnorm_forward(Z, self.params['gamma'+str(i)], \
                                      self.params['beta'+str(i)], self.bn_params[i-1])
            A, cache3 = relu_forward(Z)
            caches.extend([cache1, cache2, cache3])           
